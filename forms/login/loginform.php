...
echo ('<fieldset><legend>Logado como</legend> 
		<a href="../'.$_SESSION['projeto'].'/action/logout.php"><img src="/'.$_SESSION['projeto'].'/css/images/sair.png" /></a>
	   <a href="CentralUsuario.php"><img src="/'.$_SESSION['projeto'].'/css/images/perfil.jpg" /></a><br />
