...
<form name="arquivo" id="departamento" method="post" action="../<?php echo($_SESSION['projeto']); ?>/action/departamento.php">
  <table border="0" cellspacing="5">
    ...
    <tr>
      <td colspan="2" align="right">
  		  <input type="hidden" name="AcaoSubmit" value="<?php echo(date('s'));?>" />		
