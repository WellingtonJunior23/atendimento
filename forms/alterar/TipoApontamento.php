...
$_SESSION['cadastrar/TipoApontamento'] = $tbTipoApontamento->getForm(base64_decode($_SESSION['valorform'])); 
...
<table>
	<tr>
		<td>
			<fieldset>
				<legend>Alterar Tipo Apontamento</legend>
<form name="arquivo" method="post" action="../<?php echo($_SESSION['projeto']); ?>/action/TipoApontamento.php">
  <table border="0" cellspacing="5">
    ...
    <tr>
      ...
      <td>
      	<input name="tap_codigo" type="hidden" value="<?php echo($_SESSION['cadastrar/TipoApontamento']['tap_codigo']); ?>" />      
