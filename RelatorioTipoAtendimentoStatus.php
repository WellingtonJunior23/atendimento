...
Texto::criarTitulo("Relatório: Quantidade de Tipo Atendimento por Status");
echo "</div>";
...
$cabecalho = array('Quantidade','Tipo de Atendimento','Status');

$dados = $busca->getRelatorioTipoAtendimentoStatus();
