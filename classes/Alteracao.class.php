...
class Alteracao extends Dados
{
	...
	public function alterarAtendimento()
	{
		try
		{
			...
			ValidarCampos::validaQtdCaracter($this->dados['at_descricao'], 20,'Descriзгo');
			...
			$this->dados['ta_codigo'];
			$this->dados['td_codigo'];
			$this->dados['sat_codigo'] = 1;
			$this->dados['at_descricao'];
			...
			try
			{
				...
				$tbAtendimento->update($this->dados);
	...
	public function alterarTipoDirecionamento()
	{

		try
		{

			ValidarCampos::campoVazio($this->dados['td_descricao'],'Descriзгo');

			try
			{
				$tbTipoDirecionamento = new TbTipoDirecionamento();

				$tbTipoDirecionamento->update($this->dados);
	...
	public function alterarTipoAtendimento()
	{
		...
		try
		{
			...
			try
			{
				...
				$tbTipoAtendimento->update($this->dados);
	...
	public function alterarTipoResposta()
	{
		...
		try{
			...
			ValidarCampos::campoVazio($this->dados['tir_descricao'],'Texto Padrгo');
	...
	public function alterarTipoApontamento()
	{
		...
		try{
			...
			ValidarCampos::campoVazio($this->dados['tap_descricao'],'Texto Padrгo');
			ValidarCampos::campoVazio($this->dados['at_codigo'],'Tipo de Atendimento');
	...
	public function alterarTipoProcesso()
	{
		...
		try{
			...
			ValidarCampos::campoVazio($this->dados['ttp_descricao'],'Descriзгo');
