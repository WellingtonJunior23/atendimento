...
class DataGrid
{
	...
	public $nomelink = "<img src='/atendimento/css/images/editar.gif' />";

	public $nomelink2 = '<img src="/atendimento/css/images/adcionar.png" />';
	 ...
	 * link = 'link.php'
	 */
	public $link = '/atendimento/action/formcontroler.php';
	public $link2 = '/atendimento/action/formcontroler.php';
	...
	private function colunaLink2($campo)
	{
		if($this->islink2)
		{
			echo("<td class='{$this->csstabela}'><a href='{$this->link2}?{$this->getAcao2()}={$campo}' 
					  class='{$this->csstabela}' target='_blank' >{$this->nomelink2}</a></td>");
		}
	}
